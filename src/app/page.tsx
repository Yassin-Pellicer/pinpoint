      ...
      {loading ? (
        ...
        <main className="overflow-hidden">
          ...
          <div className="flex justify-center h-[1000px]">
            ...
            <div className="relative flex flex-col justify-center items-center h-fit m-auto z-10 md: mx-10">
              <div className="">
                <Logo />
              </div>
              <p
                className="md:text-6xl text-3xl font-extrabold md:mt-20 mt-10 text-center max-w-[800px]
          text-white drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)] tracking-tight"
              >
                {t("title")}
              </p>
              <p
                className="text-2xl md:text-4xl font-caveat font-extrabold md:mt-16 mt-5 text-center max-w-[800px]

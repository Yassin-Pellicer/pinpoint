    ...
    <form className="flex flex-col px-3 w-full">
      ...
      <input
        ...
        onChange={(e) => {
          ...
          updatedCheckpoints[index] = { ...updatedCheckpoints[index], description: e.target.value };
      ...
      <div className="flex flex-col mb-24">
        ...
        <Quill key={index} style={{ height: "125px" }} />
      </div>
      <button
      ...
      <div className="flex justify-center items-center">
        <button id="toggle" onClick={() => setToggleDetails((prev) => !prev)} className="mb-4">
          {toggleDetails ? (
            <img
              src="/svg/arrow.svg"
    ...
    <div className="flex flex-col">
      ...
      >
        ...
        <div className="max-w-[300px]">
          <h1 className="font-bold break-words">{checkpoints[index].description}</h1>
          <p className="text-xs">
            {checkpoints[index].marker.position[0]}, {checkpoints[index].marker.position[1]}
          </p>
        </div>
        <button onClick={() => setToggleDetails((prev) => !prev)} className="ml-auto">
          {toggleDetails ? (
            <img
              src="/svg/arrow.svg"
              alt="Description of image"
